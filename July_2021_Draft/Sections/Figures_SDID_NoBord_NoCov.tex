...
\begin{figure}[t] 
    \setlength\abovecaptionskip{-2\baselineskip}
	\caption{\label{fig:med_exp_plots_pa} \centering A Comparison Between DID, SC, and SDID Estimates and Placebo Analysis for the Effect of Dropping NH-CON Regulations on Per Capita Medicaid Nursing Home Expenditure in North Dakota} {\centering\includegraphics[width=\textwidth,keepaspectratio]{SynthDID_NoBord_NoCov/med_exp_plots_ND.pdf}}
    \vspace{-1.4cm}\\
    \scriptsize
